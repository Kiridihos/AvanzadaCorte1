...
public class MostrarDesfile extends javax.swing.JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MostrarDesfile frame = new MostrarDesfile();
	...
	public MostrarDesfile() {
		...
		JLabel tituloLbl = new JLabel("Lista Desfiles");
