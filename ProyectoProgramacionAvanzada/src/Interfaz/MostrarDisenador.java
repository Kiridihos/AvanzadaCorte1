...
public class MostrarDisenador extends javax.swing.JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MostrarDisenador frame = new MostrarDisenador();
	...
	public MostrarDisenador() {
		...
		JLabel tituloLbl = new JLabel("Lista Dise\u00F1adores");
