...
public class MostrarPabellon extends javax.swing.JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MostrarPabellon frame = new MostrarPabellon();
	...
	public MostrarPabellon() {
		...
		JLabel tituloLbl = new JLabel("Lista Pabellon");
